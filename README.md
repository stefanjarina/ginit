...
- commit the initial set of files (asking first when files that look like secrets, e.g. `.env` or `*.pem`, would be committed; the patterns are `secret_patterns` in the config file)
